package com.oseungjun.todosummer.main
...
import com.oseungjun.todosummer.core.common.localization.ProvideStringResources
import com.oseungjun.todosummer.core.common.localization.getStringResources
import com.oseungjun.todosummer.core.common.localization.stringResource
import com.oseungjun.todosummer.core.ui.theme.AppTheme
import com.oseungjun.todosummer.core.ui.theme.ThemeMode
import com.oseungjun.todosummer.feature.calendar.presentation.CalendarRoute
import com.oseungjun.todosummer.feature.statistics.presentation.StatisticsRoute
import com.oseungjun.todosummer.feature.settings.SettingsScreen
import com.oseungjun.todosummer.feature.todo.presentation.TodoListRoute
...
fun MainBottomBarPreview() {
    var selectedTab by remember { mutableStateOf(MainTab.HOME) }
    val stringResources = getStringResources(com.oseungjun.todosummer.core.common.localization.LanguageMode.ENGLISH)
...
class MainAppState(
    ...
    val languageMode: StateFlow<com.oseungjun.todosummer.core.common.localization.LanguageMode> =
        preferencesRepository.languageMode.stateIn(
            scope = scope,
            started = SharingStarted.Eagerly,
            initialValue = com.oseungjun.todosummer.core.common.localization.LanguageMode.KOREAN
        )
    ...
    fun setLanguageMode(mode: com.oseungjun.todosummer.core.common.localization.LanguageMode) {
        scope.launch {
